describe("Contact form", () => {
  ...
  it("should show an error message if the email format is incorrect", () => {
    cy.visit("/contact");
  ...
  it("should show an error message if the phone number format is incorrect", () => {
    cy.visit("/contact");
  ...
  it("should show an error message if the message field is empty", () => {
    cy.visit("/contact");
    cy.get('button[type="submit"]').click();
